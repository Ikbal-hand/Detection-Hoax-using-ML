...
namespace SampleClassification.ConsoleApp
{
    ...
    {
        public const string RetrainFilePath =  @"/home/zero/Downloads/hoax ml/data/dataset_sample.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"ID",outputColumnName:@"ID")      
                                    .Append(mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"tanggal",outputColumnName:@"tanggal"))      
                                    .Append(mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"judul",outputColumnName:@"judul"))      
                                    .Append(mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"narasi",outputColumnName:@"narasi"))      
                                    .Append(mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"nama file gambar",outputColumnName:@"nama file gambar"))      
                                    .Append(mlContext.Transforms.Concatenate(@"Features", new []{@"ID",@"tanggal",@"judul",@"narasi",@"nama file gambar"}))      
